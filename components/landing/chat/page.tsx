...
const ChatComponent: React.FC = () => {
    ...
    const MessageBubble: React.FC<MessageBubbleProps> = ({message}) => {
        ...
        return (
            <div className={`flex ${message.sender === "user" ? "justify-end" : "justify-start"}`}>
                <div className={`flex gap-2 max-w-[80%] min-w-[40px] ${
                    ...
                    <div className={`rounded-lg p-3 break-words ${
                        ...
                        <div className="flex items-center gap-2 mt-1">
                            <span className="text-xs text-zinc-300 opacity-75">
    ...
    return (
        <div className="w-full max-h-96 sm:h-[600px] max-w-2xl mx-auto dark">
            <Card className="h-full flex flex-col bg-zinc-900 border-zinc-800 rounded-none sm:rounded-lg">
                <div className="p-4 border-b border-zinc-800 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="font-semibold text-zinc-100">Support Chat</h2>
