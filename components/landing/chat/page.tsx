...
const ChatComponent: React.FC<Props> = ({
    ...
    const initializeWebSocket = () => {
        ...
        newSocket.on('streamComplete', () => {
            ...
            setMessages(prevMessages => {
                ...
                const lastUserMessageIndex = [...updatedMessages].reverse()
    ...
    return (
        <div className={`sm:h-[600px] mx-auto dark ${className}`}
             style={{width: 550, maxWidth: '100%', maxHeight: isMobile ? 'calc(100dvh - 98px)' : 400}}>
