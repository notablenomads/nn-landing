        ...
        >
            ...
            <div className="relative z-10 p-6">
                <div className="relative overflow-hidden rounded-lg mb-6 group">
                    ...
                    />
                    <Badge
                        className="absolute top-4 right-4 z-20 p-1 rounded bg-gray-800 text-gray-100"
                    >
                        {post.category}
                    </Badge>
                </div>
        ...
        <section className="w-full min-h-screen bg-[#121212] pb-16">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16">
                ...
                >
                    ...
                    <p className="text-lg text-gray-400">Stay up to date with the latest news and updates from our team.</p>
                </motion.div>
