            ...
            <div key={index} className="flex flex-col items-center">
              ...
              <div className="text-center bg-black bg-opacity-75 p-4 w-64 rounded">
                ...
                <div className="flex justify-center space-x-4">
                  ...
                  >
                    <Image src="/social/github.png" alt="GitHub" width={30} height={30} className="rounded" />
                  </a>
                  <a
                    ...
                    className="transition-opacity hover:opacity-80"
                  >
                    <Image src="/social/linkedin.png" alt="LinkedIn" width={30} height={30} className="rounded" />
                  </a>
                </div>
